...
class LeafNode(object):
    def __init__(self, yhat):
        # from tree builder's implementation, yhat is the mean of y reached this node.
        self.yhat = yhat

    def predict(self, X):
        # simply return yhat as the prediction
        # Do outer product here to match the size of X.
